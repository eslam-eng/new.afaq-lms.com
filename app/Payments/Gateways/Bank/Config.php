...
class Config
{
    ...
    public static $SUCCESS_URL = "/ar/checkout/banktransfer/complete";
    public static $TEST_SUCCESS_URL = "/ar/checkout/banktransfer/complete";

    public static $ADMIN_SUCCESS_URL = "/ar/checkout/banktransfer/byadmin/complete";
    public static $TEST_ADMIN_SUCCESS_URL = "/ar/checkout/banktransfer/byadmin/complete";
    ...
    public function __construct()
    {
        ...
        $this->ADMIN_SUCCESS_URL = $domain . $this->ADMIN_SUCCESS_URL;
        $this->TEST_ADMIN_SUCCESS_URL = $domain . $this->TEST_ADMIN_SUCCESS_URL;
    }
}
