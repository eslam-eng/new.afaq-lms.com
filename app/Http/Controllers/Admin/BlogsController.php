...
class BlogsController extends Controller
{
    ...
    public function index()
    {
        ...
        $blogs = Blog::with(['categories', 'tags', 'media', 'editor'])->orderBy('id', 'desc')->get();
    ...
    public function create()
    {
        ...
        $editors = Editor::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
        $tags = ContentTag::all()->pluck('name', 'id');

        return view('admin.blogs.create', compact('categories', 'tags', 'editors'));
    }
    ...
    public function edit(Blog $blog)
    {
        ...
        $tags = ContentTag::all()->pluck('name', 'id');
        $editors = Editor::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
        $blog->load('categories', 'tags', 'editor');

        return view('admin.blogs.edit', compact('categories', 'tags', 'editors', 'blog'));
    }
    ...
    public function show(Blog $blog)
    {
        ...
        $blog->load('categories', 'tags', 'blogBlogscomments', 'editor');
