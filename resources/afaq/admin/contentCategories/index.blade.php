...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.contentCategory.title_singular') }}
    </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-ContentCategory">
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $contentCategory->id }}">
                        ...
                        <td>
                            {{ app()->getLocale() == 'en' ? $contentCategory->name : $contentCategory->name_ar }}
                        </td>
                        <td>
                            {{ $contentCategory->slug ?? '' }}
                        </td>
                        <td>
                            {{ App\Models\ContentCategory::TYPE_SELECT[$contentCategory->type] ?? '' }}
                        </td>
                        <td>
                            @can('content_category_show')
                            <a href="{{ route('admin.content-categories.edit', $contentCategory->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            <a href="{{ route('admin.content-categories.edit', $contentCategory->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
