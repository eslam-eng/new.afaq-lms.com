...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.businessSpecialRequest.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.business-special-requests.update", [$businessSpecialRequest->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('event_type') ? 'is-invalid' : '' }}" name="event_type_id" id="event_type_id" required>
                    @foreach($event_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('event_type_id') ? old('event_type_id') : $businessSpecialRequest->event_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_attendees') ? 'is-invalid' : '' }}" type="text" name="number_of_attendees" id="number_of_attendees" value="{{ old('number_of_attendees', $businessSpecialRequest->number_of_attendees) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('event_starting_date') ? 'is-invalid' : '' }}" type="date" name="event_starting_date" id="event_starting_date"
                       value="{{ old('event_starting_date', date('Y-m-d',strtotime($businessSpecialRequest->event_starting_date))) }}"required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('details') ? 'is-invalid' : '' }}" name="details" id="details" required>{{ old('details', $businessSpecialRequest->details) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}" type="text" name="full_name" id="full_name" value="{{ old('full_name', $businessSpecialRequest->full_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employer') ? 'is-invalid' : '' }}" type="text" name="employer" id="employer" value="{{ old('employer', $businessSpecialRequest->employer) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_title') ? 'is-invalid' : '' }}" type="text" name="job_title" id="job_title" value="{{ old('job_title', $businessSpecialRequest->job_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $businessSpecialRequest->phone_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_address') ? 'is-invalid' : '' }}" type="email" name="email_address" id="email_address" value="{{ old('email_address', $businessSpecialRequest->email_address) }}" required>
...
{{--                        <input class="form-check-input" type="radio" id="accept_terms_{{ $key }}" name="accept_terms" value="{{ $key }}" {{ old('accept_terms', $businessSpecialRequest->accept_terms) === (string) $key ? 'checked' : '' }} required>--}}
