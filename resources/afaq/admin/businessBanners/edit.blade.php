...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.businessBanner.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.business-banners.update", [$businessBanner->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text"
                           name="title_en" id="title_en" value="{{ old('title_en', $businessBanner->title_en) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text"
                           name="title_ar" id="title_ar" value="{{ old('title_ar', $businessBanner->title_ar) }}"
                           required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description_en') ? 'is-invalid' : '' }}"
                              name="description_en"
                              id="description_en">{!! old('description_en', $businessBanner->description_en) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description_ar') ? 'is-invalid' : '' }}"
                              name="description_ar"
                              id="description_ar">{!! old('description_ar', $businessBanner->description_ar) !!}</textarea>
                ...
                {{-- <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('short_description_en') ? 'is-invalid' : '' }}"
                           ...
                           value="{{ old('short_description_en', $businessBanner->short_description_en) }}">
                ...
                <div class="form-group">
                    <label class="required"
                           for="short_description_ar">{{ trans('cruds.businessBanner.fields.short_description_ar') }}</label>
                    <input class="form-control {{ $errors->has('short_description_ar') ? 'is-invalid' : '' }}"
                           type="text" name="short_description_ar" id="short_description_ar"
                           value="{{ old('short_description_ar', $businessBanner->short_description_ar) }}" required>
