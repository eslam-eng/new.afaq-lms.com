...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.homePageSlider.title_singular') }} 
    </div>
...
<td></td>
                        ...
                        <td>
                            @can('home_page_slider_show')
                                ...
                                <a href="{{ route('admin.home-page-sliders.show', $homePageSlider->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('home_page_slider_edit')
                                    ...
                                    <a href="{{ route('admin.home-page-sliders.edit', $homePageSlider->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
