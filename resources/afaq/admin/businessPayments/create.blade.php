...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.businessPayment.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.business-payments.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_number') ? 'is-invalid' : '' }}" type="number" name="event_number" id="event_number" value="{{ old('event_number', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('speakers_number') ? 'is-invalid' : '' }}" type="number" name="speakers_number" id="speakers_number" value="{{ old('speakers_number', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('digital_marketing_event') ? 'is-invalid' : '' }}" name="digital_marketing_event" id="digital_marketing_event">
                    ...
                    @foreach(App\Models\BusinessPayment::DIGITAL_MARKETING_EVENT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('digital_marketing_event', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('initial_response') ? 'is-invalid' : '' }}" type="text" name="initial_response" id="initial_response" value="{{ old('initial_response', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status_response') ? 'is-invalid' : '' }}" type="text" name="status_response" id="status_response" value="{{ old('status_response', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_number') ? 'is-invalid' : '' }}" type="text" name="payment_number" id="payment_number" value="{{ old('payment_number', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('package_price_type') ? 'is-invalid' : '' }}" name="package_price_type" id="package_price_type">
                    ...
                    @foreach(App\Models\BusinessPayment::PACKAGE_PRICE_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('package_price_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
