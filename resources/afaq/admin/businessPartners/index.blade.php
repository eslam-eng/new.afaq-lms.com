                        ...
                        <tr data-entry-id="{{ $businessPartner->id }}">
                            ...
                            <td>
                                @can('business_partner_show')
                                    <a href="{{ route('admin.business-partners.show', $businessPartner->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                                ...
                                @can('business_partner_edit')
                                        ...
                                        <a href="{{ route('admin.business-partners.edit', $businessPartner->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
