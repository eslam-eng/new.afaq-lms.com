...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.businessPackage.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" class="row" action="{{ route("admin.business-packages.update", [$businessPackage->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group col-xl-6 col-lg-6 col-md-12">
                ...
                <input class="form-control {{ $errors->has('package_name_en') ? 'is-invalid' : '' }}" type="text" name="package_name_en" id="package_name_en" value="{{ old('package_name_en', $businessPackage->package_name_en) }}" required>
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-12">
                ...
                <input class="form-control {{ $errors->has('package_name_ar') ? 'is-invalid' : '' }}" type="text" name="package_name_ar" id="package_name_ar" value="{{ old('package_name_ar', $businessPackage->package_name_ar) }}" required>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('online') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="online" id="online" value="1" {{ $businessPackage->online || old('online', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('hybrid') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hybrid" id="hybrid" value="1" {{ $businessPackage->hybrid || old('hybrid', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('onsite') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="onsite" id="onsite" value="1" {{ $businessPackage->onsite || old('onsite', 0) === 1 ? 'checked' : '' }}>
            ...
            {{-- <div class="form-group col-xl-6 col-lg-6 col-md-12">
                ...
                <input class="form-control {{ $errors->has('price_package_annual') ? 'is-invalid' : '' }}" type="text" name="price_package_annual" id="price_package_annual" value="{{ old('price_package_annual', $businessPackage->price_package_annual) }}">
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-12">
                ...
                <input class="form-control {{ $errors->has('package_annual_price_offers') ? 'is-invalid' : '' }}" type="text" name="package_annual_price_offers" id="package_annual_price_offers" value="{{ old('package_annual_price_offers', $businessPackage->package_annual_price_offers) }}">
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-12">
                ...
                <input class="form-control {{ $errors->has('price_package_month') ? 'is-invalid' : '' }}" type="text" name="price_package_month" id="price_package_month" value="{{ old('price_package_month', $businessPackage->price_package_month) }}" required>
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-12">
                ...
                <input class="form-control {{ $errors->has('package_month_price_offers') ? 'is-invalid' : '' }}" type="text" name="package_month_price_offers" id="package_month_price_offers" value="{{ old('package_month_price_offers', $businessPackage->package_month_price_offers) }}">
                ...
                <div class="row">
                    <div class="form-group col-xl-6 col-lg-6 col-md-12">
                        <label for="event_number">{{ trans('cruds.businessPackage.fields.event_number') }}</label>
                         <input class="form-control {{ $errors->has('event_number') ? 'is-invalid' : '' }}" type="text" name="event_number" id="event_number" value="{{ old('event_number', $businessPackage->event_number) }}" step="1">
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-12">
                        ...
                        <input class="form-control {{ $errors->has('event_number_days') ? 'is-invalid' : '' }}" type="text" name="event_number_days" id="event_number_days" value="{{ old('event_number_days', $businessPackage->event_number_days) }}" step="1">
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-12">
                ...
                <input class="form-control {{ $errors->has('speakers_number') ? 'is-invalid' : '' }}" type="text" name="speakers_number" id="speakers_number" value="{{ old('speakers_number', $businessPackage->speakers_number) }}" step="1" required>
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-12">
                ...
                <input class="form-control {{ $errors->has('attendance_trainees_number') ? 'is-invalid' : '' }}" type="number" name="attendance_trainees_number" id="attendance_trainees_number" value="{{ old('attendance_trainees_number', $businessPackage->attendance_trainees_number) }}" step="1">
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-12">
                ...
                <input class="form-control {{ $errors->has('remote_trainees_number') ? 'is-invalid' : '' }}" type="number" name="remote_trainees_number" id="remote_trainees_number" value="{{ old('remote_trainees_number', $businessPackage->remote_trainees_number) }}" step="1">
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('electronic_registration_system') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="electronic_registration_system" id="electronic_registration_system" value="1" {{ $businessPackage->electronic_registration_system || old('electronic_registration_system', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('e_certificate') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="e_certificate" id="e_certificate" value="1" {{ $businessPackage->e_certificate || old('e_certificate', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('customize_event_with_host_identity') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="customize_event_with_host_identity" id="customize_event_with_host_identity" value="1" {{ $businessPackage->customize_event_with_host_identity || old('customize_event_with_host_identity', 0) === 1 ? 'checked' : '' }}>
...
{{--                        <option value="{{ $key }}" {{ old('digital_marketing_event', $businessPackage->digital_marketing_event) === (string) $key ? 'selected' : '' }}>{{ trans('afaq.'.$label)  }}</option>--}}
{{--                    @endforeach--}}
{{--                </select>--}}
...
{{--            </div>--}}
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('digital_marketing_event') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="digital_marketing_event" id="digital_marketing_event" value="1" {{ $businessPackage->digital_marketing_event || old('digital_marketing_event', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('event_fees') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="event_fees" id="event_fees" value="1" {{ $businessPackage->event_fees || old('event_fees', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('advertising_afaq_core') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="advertising_afaq_core" id="advertising_afaq_core" value="1" {{ $businessPackage->advertising_afaq_core || old('advertising_afaq_core', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('quality_control_inquiries') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="quality_control_inquiries" id="quality_control_inquiries" value="1" {{ $businessPackage->quality_control_inquiries || old('quality_control_inquiries', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('help_center_customer_response') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="help_center_customer_response" id="help_center_customer_response" value="1" {{ $businessPackage->help_center_customer_response || old('help_center_customer_response', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('technical_support') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="technical_support" id="technical_support" value="1" {{ $businessPackage->technical_support || old('technical_support', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('event_accreditation') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="event_accreditation" id="event_accreditation" value="1" {{ $businessPackage->event_accreditation || old('event_accreditation', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('event_free_collection') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="event_free_collection" id="event_free_collection" value="1" {{ $businessPackage->event_free_collection || old('event_free_collection', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('e_certificate_speaker') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="e_certificate_speaker" id="e_certificate_speaker" value="1" {{ $businessPackage->e_certificate_speaker || old('e_certificate_speaker', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('two_email_trainees') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="two_email_trainees" id="two_email_trainees" value="1" {{ $businessPackage->two_email_trainees || old('two_email_trainees', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('target_groups_mails') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="target_groups_mails" id="target_groups_mails" value="1" {{ $businessPackage->target_groups_mails || old('target_groups_mails', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('electronic_testing_system') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="electronic_testing_system" id="electronic_testing_system" value="1" {{ $businessPackage->electronic_testing_system || old('electronic_testing_system', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('effectiveness_rating_system') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="effectiveness_rating_system" id="effectiveness_rating_system" value="1" {{ $businessPackage->effectiveness_rating_system || old('effectiveness_rating_system', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('discount_free_coupon') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="discount_free_coupon" id="discount_free_coupon" value="1" {{ $businessPackage->discount_free_coupon || old('discount_free_coupon', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('event_reports') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="event_reports" id="event_reports" value="1" {{ $businessPackage->event_reports || old('event_reports', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('attendance_absence_qr_system') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="attendance_absence_qr_system" id="attendance_absence_qr_system" value="1" {{ $businessPackage->attendance_absence_qr_system || old('attendance_absence_qr_system', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('printable_id_card') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="printable_id_card" id="printable_id_card" value="1"  {{ $businessPackage->printable_id_card || old('printable_id_card', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('conference_workshops_attendance') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="conference_workshops_attendance" id="conference_workshops_attendance" value="1" {{ $businessPackage->conference_workshops_attendance || old('conference_workshops_attendance', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('send_messages_event_participants') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="send_messages_event_participants" id="send_messages_event_participants" value="1" {{ $businessPackage->send_messages_event_participants || old('send_messages_event_participants', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('event_notification_mobile') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="event_notification_mobile" id="event_notification_mobile" value="1" {{ $businessPackage->event_notification_mobile || old('event_notification_mobile', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('fixed_advertising_banner') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="fixed_advertising_banner" id="fixed_advertising_banner" value="1" {{ $businessPackage->fixed_advertising_banner || old('fixed_advertising_banner', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group col-xl-4 col-lg-4 col-md-12">
                <div class="form-check {{ $errors->has('responsible_employee_manage_event') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="responsible_employee_manage_event" id="responsible_employee_manage_event" value="1" {{ $businessPackage->responsible_employee_manage_event || old('responsible_employee_manage_event', 0) === 1 ? 'checked' : '' }}>
