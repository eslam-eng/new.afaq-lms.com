...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.userAttendance.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-attendances.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('attendance_design') ? 'is-invalid' : '' }}" name="attendance_design_id" id="attendance_design_id">
                    @foreach($attendance_designs as $id => $entry)
                        <option value="{{ $id }}" {{ old('attendance_design_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lecture') ? 'is-invalid' : '' }}" type="number" name="lecture" id="lecture" value="{{ old('lecture', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('attend_time') ? 'is-invalid' : '' }}" type="text" name="attend_time" id="attend_time" value="{{ old('attend_time') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('leave_time') ? 'is-invalid' : '' }}" type="text" name="leave_time" id="leave_time" value="{{ old('leave_time') }}">
