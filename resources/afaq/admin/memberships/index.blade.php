...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.membership.title_singular') }} 
    </div>
...
<th></th>
                        ...
                        <th>
                            {{ trans('cruds.membership.fields.subscribtion_count') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
<td></td>
                        ...
                        <td>
                            {{ $membership->subscribtion_count ?? 0 }}
                        </td>
                        <td>
                            @can('membership_show')

                                <a href="{{ route('admin.memberships.show', $membership->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('membership_edit')
                                    ...
                                    <a href="{{ route('admin.memberships.edit', $membership->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
