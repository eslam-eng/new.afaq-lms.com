    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.coupon-codes.update", [$couponCode->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('coupon_use_number') ? 'is-invalid' : '' }}" type="number" name="coupon_use_number" id="coupon_use_number" value="{{ old('coupon_use_number', $couponCode->coupon_use_number) }}" step="1">
