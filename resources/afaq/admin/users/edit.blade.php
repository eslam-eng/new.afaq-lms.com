    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('full_name_ar') ? 'is-invalid' : '' }}" type="text" name="full_name_ar" id="full_name_ar" value="{{ old('full_name_ar', $user->full_name_ar) }}" placeholder="{{ trans('frontend.register.Full Name Arabic') }}">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('full_name_en') ? 'is-invalid' : '' }}" type="text" name="full_name_en" id="full_name_en" minlength="3" maxlength="50" value="{{ old('full_name_en', $user->full_name_en) }}" required placeholder="{{ trans('frontend.register.Full Name English') }}">
                        <div class="invalid-feedback"></div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="selectContainer">
                            <select class="form-control col-auto d-inline {{ $errors->has('name_title') ? 'is-invalid' : '' }}" id="title" name="name_title">
                                <option value=""> {{ trans('global.pleaseSelect') }}</option>
                                <option value="Mr." {{ old('name_title',  $user->name_title) == 'Mr.' ? 'selected' : ''}}>Mr.</option>
                                <option value="Ms." {{ old('name_title',  $user->name_title) == 'Ms.' ? 'selected' : ''}}>Ms.</option>
                                <option value="Dr." {{ old('name_title',  $user->name_title) == 'Dr.' ? 'selected' : ''}}>Dr.</option>
                                <option value="Prof." {{ old('name_title',  $user->name_title) == 'Prof.' ? 'selected' : ''}}>Prof.</option>
                            </select>
                        </div>
                        <div class="invalid-feedback"></div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="selectContainer">
                            <select class="form-control col-auto d-inline {{ $errors->has('gender') ? 'is-invalid' : '' }}" id="gender" name="gender">
                                <option value=""> {{ trans('global.pleaseSelect') }}</option>
                                <option value="male" {{ old('gender', $user->gender) == 'male' ? 'selected' : $user->gender}}>{{app()->getLocale()=='ar'?'ذكر':'Male'}} </option>
                                <option value="female" {{ old('gender', $user->gender) == 'female' ? 'selected' : ''}}>{{app()->getLocale()=='ar'?'أنثي':'Female'}}</option>
                            </select>
                        </div>
                        <div class="invalid-feedback"></div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="selectContainer">
                            <select class="form-control col-auto d-inline {{ $errors->has('nationality_id') ? 'is-invalid' : '' }}" id="nationality_id" name="nationality_id">
                                <option value=""> {{ trans('global.pleaseSelect') }}</option>

                                @foreach($countries as $item)
                                <option value="{{$item->id}}" data-code="{{$item->country_code}}" {{ $item->id == old('nationality_id', $user->nationality_id) ? 'selected' : ''}}>{{$item->nationality}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="invalid-feedback"></div>
                ...
                {{-- <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="selectContainer">
                            <select class="form-control col-auto d-inline  {{ $errors->has('identity_type') ? 'is-invalid' : '' }}" id="identity_type" name="identity_type">
                                <option value=""> {{ trans('global.pleaseSelect') }}</option>
                                <option value="national_id" {{ old('identity_type', $user->identity_type) == 'national_id' ? 'selected' : '' }}>{{__('frontend.national_id')}}</option>
                                <option value="resident_id" {{ old('identity_type', $user->identity_type) == 'resident_id' ? 'selected' : '' }}>{{__('frontend.resident_id')}}</option>
                                <option value="passport" {{ old('identity_type', $user->identity_type) == 'passport' ? 'selected' : '' }}>{{__('frontend.passport')}}</option>
                                <option value="non_resident" {{ old('identity_type', $user->identity_type) == 'non_resident' ? 'selected' : '' }}>{{__('frontend.non_resident')}}</option>
                            </select>
                        </div>
                        <div class="invalid-feedback"></div>
                ...
                {{-- <div class="col-lg-6 col-md-12" id="identity_number_form">
                    <div class="form-group">
                        ...
                        <input type="number" id="identity_number" required name="identity_number" class="form-control{{ $errors->has('identity_number') ? ' is-invalid' : '' }}" placeholder="{{ trans('frontend.register.identity_number') }}" value="{{ old('identity_number', $user->identity_number) }}">
                        <div class="invalid-feedback"></div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <select onchange="get_sub_specialists()" class="form-control {{ $errors->has('specialty_id') ? 'is-invalid' : '' }}" name="specialty_id" id="specialty_id">
                            ...
                            <option value="{{ $key }}" {{ old('specialty_id', $user->specialty_id) == (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback"></div>
                ...
                <div class="col-lg-6 col-md-12" id="sub">
                    <div class="form-group">
                        ...
                        <select  class="form-control {{ $errors->has('specialty_id') ? 'is-invalid' : '' }}" name="sub_specialty_id" id="sub_specialty_id">
                            <option value disabled {{ old('sub_specialty_id', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                            @foreach($sub_specialists as $key => $label)
                            <option value="{{ $key }}" {{ old('sub_specialty_id', $user->sub_specialty_id) == (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                        </div>
                        <div class="invalid-feedback"></div>
                ...
                <div class="col-lg-6 col-md-12 occupational_classification_number">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('occupational_classification_number') ? 'is-invalid' : '' }}" type="text" name="occupational_classification_number" id="occupational_classification_number" value="{{ old('occupational_classification_number', $user->occupational_classification_number) }}" placeholder="{{ trans('frontend.register.hint_helper') }}">
                        <div class="invalid-feedback"></div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class=" mb-3 form-group">
                        ...
                        <input type="email" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" required placeholder="{{ trans('frontend.register.Email') }}" value="{{ old('email', $user->email) }}">
                        <div class="invalid-feedback"></div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="mobile_code" value="{{ old('phone', $user->phone) }}">
                        <div class="invalid-feedback"></div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group ">
                        ...
                        <div class="d-flex justify-content-between align-items-center required">
                            <input type="password" id="password" name="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" minlength="8" maxlength="50" placeholder="{{ trans('frontend.register.Password') }}">
                        </div>
            ...
            <div class="form-group" hidden>
                ...
                <select style="width: 100%;" class="form-control select2 {{ $errors->has('roles') ? 'is-invalid' : '' }}" name="roles[]" id="roles" multiple>
                    @foreach($roles as $id => $roles)
                    <option value="{{ $id }}" {{ in_array($id, old('roles', $user->roles->pluck('id')->toArray())) ? 'selected' : '' }}>{{ $roles }}</option>
                    @endforeach
                </select>
                @if($errors->has('roles'))
                <div class="invalid-feedback">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('input[type="file"][name="personal_photo"]').each(function() {
            // Refs
            var $file = $(this),
            ...
            $label.addClass('file-ok').css('background-image', "url('{{($user->personal_photo->getUrl('thumb'))}}')");
