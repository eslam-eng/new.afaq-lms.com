...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.university.title_singular') }} 
    </div>
...
<td></td>
                        ...
                        <td>
                            @can('university_show')
                                ...
                                <a href="{{ route('admin.universities.show', $university->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('university_edit')
                                    ...
                                    <a href="{{ route('admin.universities.edit', $university->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
