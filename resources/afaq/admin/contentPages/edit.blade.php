...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="title_ar">{{ trans('cruds.contentPage.fields.title_ar') }}</label>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type" required>
                    ...
                    @foreach(App\Models\ContentPage::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', $contentPage->type) === (string) $key ? 'selected' : '' }}>{{ trans('afaq.'.$label)  }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                <label>{{ trans('cruds.contentPage.fields.show_in_menu') }}</label>
                @foreach(App\Models\ContentPage::SHOW_IN_MENU as $key => $label)
                <div class="form-check {{ $errors->has('show_in_menu') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="radio" id="show_in_menu_{{ $key }}" name="show_in_menu" value="{{ $key }}" {{ old('show_in_menu', $contentPage->show_in_menu) === (int) $key ? 'checked' : '' }}>
                    <label class="form-check-label" for="show_in_menu_{{ $key }}">{{ $label }}</label>
                </div>
                @endforeach
            </div>
