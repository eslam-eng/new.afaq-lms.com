...
{{--                            </td>--}}
                            @if($ticketCategory->statues = 1)
                                <td>
                                    {{ trans('cruds.ticketCategory.fields.Show')  }}
                                </td>
                            @else
                                <td>
                                    {{ trans('cruds.ticketCategory.fields.Hide')  }}
                                </td>
                            @endif
                            <td>
                            ...
                            <td>
                                @can('ticket_category_show')
                                    <a href="{{ route('admin.ticket-categories.show', $ticketCategory->id) }}"
                                       type="button"
                                ...
                                @can('ticket_category_edit')
                                        <a href="{{ route('admin.ticket-categories.edit', $ticketCategory->id) }}"
                                           type="button"
...
{{--                                        <form action="{{ route('admin.ticket-categories.destroy', $ticketCategory->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">--}}
