...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.testimonial.title_singular') }}
    </div>
                ...
                <tbody>
                    @foreach($testimonials as $key => $testimonial)
                        <tr data-entry-id="{{ $testimonial->id }}">
                            ...
                            <td>
                                {{ __('lms.'.App\Models\Testimonial::STATUS_RADIO[$testimonial->status]) ?? '' }}
                            ...
                            <td>
                                ...
                                @can('testimonial_show')
                                    ...
                                    <a href="{{ route('admin.testimonials.show', $testimonial->id) }}" type="button"
                                ...
                                @endcan
                                    ...
                                    @can('testimonial_edit')
                                        ...
                                        <a href="{{ route('admin.testimonials.edit', $testimonial->id) }}" type="button"
