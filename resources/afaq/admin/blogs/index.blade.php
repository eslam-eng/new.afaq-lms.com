...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.blog.title_singular') }}
    </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Blog">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.blog.fields.editor') }}
                        </th>
                        <th>
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $blog->id }}">
                        ...
                        <td>
                            {{app()->getLocale()=='en' ? $blog->title ?? '' : $blog->title_ar ?? ''}}
                        ...
                        <td>
                            ...
                            <a href="{{ $blog->featured_image->getUrl() }}" target="_blank" style="display: inline-block">
                                <img style="width: 100px;" src="{{ $blog->featured_image->getUrl() }}">
                            </a>
                            @endif
                        </td>
                        ...
                        <td>
                            @can('blog_show')
                            <a href="{{ route('admin.blogs.show', $blog->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('blog_edit')
                            <a href="{{ route('admin.blogs.edit', $blog->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
