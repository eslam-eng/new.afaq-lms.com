...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ticketComment.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ticket-comments.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author_name') ? 'is-invalid' : '' }}" type="text" name="author_name" id="author_name" value="{{ old('author_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author_email') ? 'is-invalid' : '' }}" type="text" name="author_email" id="author_email" value="{{ old('author_email', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comment_text') ? 'is-invalid' : '' }}" type="text" name="comment_text" id="comment_text" value="{{ old('comment_text', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type" required>
                    ...
                    @foreach(App\Models\TicketComment::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', 'AFAQ') === (string) $key ? 'selected' : '' }}>{{ trans('afaq.'.$label)  }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
                    <div class="invalid-feedback">
