...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.businessFeature.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.business-features.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="text_en">{{ trans('cruds.businessFeature.fields.text_en') }}</label>
                <input class="form-control {{ $errors->has('text_en') ? 'is-invalid' : '' }}" type="text" name="text_en" id="text_en" value="{{ old('text_en', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text_ar') ? 'is-invalid' : '' }}" type="text" name="text_ar" id="text_ar" value="{{ old('text_ar', '') }}" required>
