    ...
    <div class="row">
        ...
        <div class="col-4">
            <div class="form-group wrap-custom-file">
                ...
                <input type="file" value="{{ old('image_en', '') }}" name="image_en" id="image_en" required data-parsley-filemimetypes="image/jpeg, image/png" accept=".gif, .jpg, .png" data-parsley-filemimetypes="image/jpeg, image/png" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}"  data-parsley-max-file-size="5000" data-parsley-errors-container="#course_image_en" />required
                <label for="image_en">
                    <span>Image EN</span>
        ...
        <div class="col-4">
            <div class="form-group wrap-custom-file">
                ...
                <input type="file" value="{{ old('image_ar', '') }}" name="image_ar" id="image_ar" required data-parsley-filemimetypes="image/jpeg, image/png" accept=".gif, .jpg, .png" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}"  data-parsley-max-file-size="5000" data-parsley-errors-container="#course_image_ar"  />required
                <label for="image_ar">
                    <span>Image Ar</span>
                    <i class="fa fa-plus-circle"></i>
                </label>
        ...
        <div class="col-4">
            <div class="form-group wrap-custom-file">
                ...
                <input type="file" value="{{ old('banner_en', '') }}" name="banner_en" id="banner_en" required data-parsley-filemimetypes="image/jpeg, image/png" accept=".gif, .jpg, .png" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}"  data-parsley-max-file-size="5000" data-parsley-errors-container="#course_banner_en" />required
                <label for="banner_en">
                    <span>Banner EN</span>
                    <i class="fa fa-plus-circle"></i>
                </label>
        ...
        <div class="col-4">
            <div class="form-group wrap-custom-file">
                ...
                <input type="file" value="{{ old('banner_ar', '') }}" name="banner_ar" id="banner_ar" required data-parsley-filemimetypes="image/jpeg, image/png" accept=".gif, .jpg, .png" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}"  data-parsley-max-file-size="5000" data-parsley-errors-container="#course_banner_ar" />required
                <label for="banner_ar">
                    <span>Banner Ar</span>
                    <i class="fa fa-plus-circle"></i>
                </label>
