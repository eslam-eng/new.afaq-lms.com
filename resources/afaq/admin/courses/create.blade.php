...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static {{ app()->getLocale() == 'en' ? 'ltr' : 'rtl' }} " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ trans('global.create') }}
                                        {{ trans('cruds.course.title_singular') }}
                                    </h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form id="course_form" method="POST" class="number-tab-steps wizard-circle" data-parsley-validate action="{{ route('admin.courses.store') }}" enctype="multipart/form-data">
                                            @csrf
                                            {{-- Step 1 --}}
                                            @include('admin.courses.createSteps.stepOne')
                                            {{-- Step 2 --}}
                                            @include('admin.courses.createSteps.stepTwo')
                                            {{-- Step 3 --}}
                                            @include('admin.courses.createSteps.stepThree')
                                            {{-- Step 4 --}}
                                            @include('admin.courses.createSteps.stepFour')
                                            {{-- Step 5 --}}
                                            @include('admin.courses.createSteps.stepFive')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="" class="lookups-form" enctype="multipart/form-data" data-parsley-validate select-input-id="">
                        @csrf
                        <div class="form-group">
                            <label for="title_en">{{ trans('cruds.lookup.fields.name_en') }}</label>
                            <input class="form-control" {{ $errors->has('name_en') ? 'is-invalid' : '' }} type="text" name="title_en" id="name_en" value="{{ old('name_en', '') }}" data-parsley-required-message="{{ trans('global.required') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="name_ar" value="{{ old('name_ar', '') }}" required data-parsley-required-message="{{ trans('global.required') }}">
                        ...
                        <div class="form-group wrap-custom-file">
                            ...
                            <input type="file" value="{{ old('image', '') }}" name="image" id="image-lookup" accept=".gif, .jpg, .png" data-parsley-errors-container="#lookup_images_error" data-parsley-required-message="{{ trans('global.required') }}" data-parsley-filemimetypes="image/jpeg, image/png" />required
                        ...
                        <div id="lookup_images_error"></div>
                        <div class="form-group">
    ...
    <!-- Modal -->
    <div class="modal fade" id="createInstructor" tabindex="-1" role="dialog" aria-labelledby="createInstructorLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form method="POST" class="instructor-create" action="{{ route('admin.instructors.store') }}" enctype="multipart/form-data" data-parsley-validate>
                        @csrf
                        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('mail') ? 'is-invalid' : '' }}" type="email" name="mail" id="mail" value="{{ old('mail', '') }}" required data-parsley-required-message="{{ trans('global.required') }}">
                            @if ($errors->has('mail'))
                            <div class="invalid-feedback">
                                {{ $errors->first('mail') }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password" name="password" id="password" required data-parsley-required-message="{{ trans('global.required') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile', '') }}" data-parsley-required-message="{{ trans('global.required') }}">
                        ...
                        <div class="form-group wrap-custom-file">
                            ...
                            <input type="file" value="{{ old('image', '') }}" name="image" id="image-instractor" data-parsley-required-message="{{ trans('global.required') }}" accept=".gif, .jpg, .png" data-parsley-errors-container="#inst_images_error" data-parsley-filemimetypes="image/jpeg, image/png" />required
    ...
    @include('admin.courses.create-scripts')
