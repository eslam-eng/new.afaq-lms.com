        ...
        <div class="col-12">
            ...
            <div class="row col-12">
                ...
                <div class="form-group col-6">
                    ...
                    <select class="form-control {{ $errors->has('show_for_all') ? 'is-invalid' : '' }}" name="show_for_all" id="show_for_all"  data-parsley-errors-container="#course_show_for_all" data-parsley-group="step-5" >
                        ...
                        @foreach(App\Models\Course::SHOW_FOR_ALL_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('show_for_all', $course->show_for_all) == $key ? 'selected' : '' }}>{{ trans('cruds.course.fields.'.$label)  }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-2">
                    ...
                    <input type="checkbox" data-parsley-group="step-5"  name="has_exclusive_mobile" id="has_exclusive_mobile" class="" {{ $course->has_exclusive_mobile ? 'checked' : '' }}>
                </div>
                {{-- <div class="form-group col-6">
