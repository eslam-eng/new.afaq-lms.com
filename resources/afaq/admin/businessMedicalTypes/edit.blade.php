...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.businessMedicalType.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.business-medical-types.update", [$businessMedicalType->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label for="medical_header_en">{{ trans('cruds.businessMedicalType.fields.medical_header_en') }}</label>
                    <input class="form-control {{ $errors->has('medical_header_en') ? 'is-invalid' : '' }}" type="text" name="medical_header_en" id="medical_header_en" value="{{ old('medical_header_en', $businessMedicalType->medical_header_en) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('medical_header_ar') ? 'is-invalid' : '' }}" type="text" name="medical_header_ar" id="medical_header_ar" value="{{ old('medical_header_ar', $businessMedicalType->medical_header_ar) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text" name="title_en" id="title_en" value="{{ old('title_en', $businessMedicalType->title_en) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $businessMedicalType->title_ar) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('short_description_en') ? 'is-invalid' : '' }}" type="text" name="short_description_en" id="short_description_en" value="{{ old('short_description_en', $businessMedicalType->short_description_en) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('short_description_ar') ? 'is-invalid' : '' }}" type="text" name="short_description_ar" id="short_description_ar" value="{{ old('short_description_ar', $businessMedicalType->short_description_ar) }}" required>
