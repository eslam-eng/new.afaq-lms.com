...
@section('content')
    ...
    @if(count($businessMedicalTypes)<2)
    @can('business_medical_type_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.business-medical-types.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.businessMedicalType.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.businessMedicalType.title_singular') }} {{ trans('global.list') }}
        </div>

        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-BusinessMedicalType">
                    <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tbody>
                    @foreach($businessMedicalTypes as $key => $businessMedicalType)
                        <tr data-entry-id="{{ $businessMedicalType->id }}">
                            <td>
                            ...
                            <td>
                                @can('business_medical_type_show')


                                    <a href="{{ route('admin.business-medical-types.show', $businessMedicalType->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                                ...
                                @can('business_medical_type_edit')


                                        <a href="{{ route('admin.business-medical-types.edit', $businessMedicalType->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
                                ...
                                @can('business_medical_type_delete')

                                        <form action="{{ route('admin.business-medical-types.destroy', $businessMedicalType->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.business-medical-types.massDestroy') }}",
            ...
            // let table = $('.datatable-BusinessMedicalType:not(.ajaxTable)').DataTable({ buttons: dtButtons })
