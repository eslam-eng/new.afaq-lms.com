    ...
    <div class="row">
        <div class="card-image col-9">
            ...
            <div id="certificate_image" style="display: none;">
                <div id="boxx">
                    ...
                    <canvas id="c" width="850" height="600">
                </div>
            </div>
            <div id="certificate_image_buttons" style="display: block;">
        ...
        <div class="card-body col-3">
            <div class="card_header">
                {{ trans('global.create') }} {{ trans('cruds.certificat.title_singular') }}
            </div>

            <form method="POST" action="{{ route("admin.certificats.update", [$certificat->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group certificate_name">
                    <label for="name_en">{{ trans('cruds.certificat.fields.name_en') }}</label>
                    <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" type="text" name="name_en" id="name_en" value="{{ old('name_en', $certificat->name_en) }}">
                    @if($errors->has('name_en'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name_en') }}
                    </div>
                    @endif
                    <span class="help-block">{{ trans('cruds.certificat.fields.name_en_helper') }}</span>
                </div>
                <div class="form-group certificate_name">
                    <label class="required" for="name_ar">{{ trans('cruds.certificat.fields.name_ar') }}</label>
                    <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}" type="text" name="name_ar" id="name_ar" value="{{ old('name_ar', $certificat->name_ar) }}" required>
                    @if($errors->has('name_ar'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name_ar') }}
                    </div>
                    @endif
                    <span class="help-block">{{ trans('cruds.certificat.fields.name_ar_helper') }}</span>
                </div>
                <div class="form-group wrap-custom-file add_image_button">
                    <!-- <label class="required" for="image">{{ trans('cruds.certificat.fields.image') }}</label> -->
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.certificat.fields.image_helper') }}</span>
                </div>
