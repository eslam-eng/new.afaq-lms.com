        ...
        <div class="row">
            ...
            <div class="card-body col-3">
                    ...
                    <div class="card_header">
                        {{ trans('global.edit') }} {{ trans('cruds.attendanceDesign.title_singular') }}
                    </div>

                        <form method="POST"
                              action="{{ route("admin.attendance-designs.update", [$attendanceDesign->id]) }}"
                            ...
                            <div class="form-group certificate_name">
                                ...
                                <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}"
                                       ...
                                       value="{{ old('name_en', $attendanceDesign->name_en) }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.attendanceDesign.fields.name_en_helper') }}</span>
                            </div>
                            <div class="form-group certificate_name">
                                <label class="required"
                                       for="name_ar">{{ trans('cruds.attendanceDesign.fields.name_ar') }}</label>
                                <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}"
                                       type="text" name="name_ar" id="name_ar"
                                       value="{{ old('name_ar', $attendanceDesign->name_ar) }}" required>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.attendanceDesign.fields.name_ar_helper') }}</span>
                            </div>
