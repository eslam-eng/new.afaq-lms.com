        ...
        <form method="POST" action="{{ route("admin.faq-questions.update", [$faqQuestion->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('answer_ar') ? 'is-invalid' : '' }}" name="answer_ar" id="answer_ar" required>{{ old('answer_ar', $faqQuestion->answer_ar) }}</textarea>
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('answer_en') ? 'is-invalid' : '' }}" name="answer_en" id="answer_en" required>{{ old('answer_en', $faqQuestion->answer_en) }}</textarea>
