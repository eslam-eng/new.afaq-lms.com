...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.system_email.title_singular') }} 
    </div>
...
<td></td>
                        ...
                        <td>
                            @can('system_email_show')
                                ...
                                <a href="{{ route('admin.system-emails.show', $system_email->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('system_email_edit')
                                    ...
                                    <a href="{{ route('admin.system-emails.edit', $system_email->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
