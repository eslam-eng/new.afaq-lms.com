...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.membershipType.title_singular') }} 
    </div>
...
<td></td>
                        ...
                        <td>
                            @can('membership_type_show')
                                ...
                                <a href="{{ route('admin.membership-types.show', $membershipType->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('membership_type_edit')
                                    ...
                                    <a href="{{ route('admin.membership-types.edit', $membershipType->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
