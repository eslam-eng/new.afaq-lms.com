        ...
        <div class="container sit-container">
            <div class="all-courses on-attend-course pb-5">
                <div class="container">
                    ...
                    <div id="boxx">
                        <canvas id="c" style="border:1px solid #000000;margin-left:30px" width="874"
                            height="1240"></canvas>
                    </div>
                    ...
                    @can('can_attend')
                        @switch($user_attendance->course->attend_type)
                            @case('attend')
                            @if (!$attend)
                                <div class="d-flex justify-content-center mt-4">
                                    <button type="button" class="btn btn-success" onclick="attend_course()">Attend</button>
                                </div>
                            @endif
                            @break
                            ...
                            @default
                                @if ($attend)
                                    @if (is_null($attend->leave_time))
                                        <div class="d-flex justify-content-center mt-4">
                                            <button type="button" class="btn btn-danger" onclick="leave_course()">Leave</button>
                                        </div>
                                    @endif
                                @else
                                    <div class="d-flex justify-content-center mt-4">
