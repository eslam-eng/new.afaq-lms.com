    ...
    <div class="col-12 all-page-details_lms">
        <div class="col-10 offset-1">
            ...
            <div class="contact-form">
                ...
                <form action="{{ route('business_enquiry') }}" method="post" >
                    @csrf
                    <div class="d-flex align-items-center justify-content-between forms-wrap">
                        <div class="text-name-form">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="{{__('contact.name')}}" minlength="2" maxlength="45" required >
                        ...
                        <div class="text-name-form">
                            ...
                            <input id="mobile_code" name="phone_number[full]" type="tel" required>
