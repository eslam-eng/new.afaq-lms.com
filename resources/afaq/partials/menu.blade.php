...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto">
                <a class="navbar-brand" href="{{ url('/') }}">
                    @if (app()->getLocale() == 'en')
                        <h2 class="brand-text mb-0 text-center"><img class="pr-1" src="{{ asset('afaq\logo.png') }}"
                                                                     style="width: 60px;"> {{ trans('panel.site_title') }}
                        </h2>
                    @else
                        <h2 class="brand-text mb-0 text-center" style="font-size: 16px;"><img
                                src="{{ asset('afaq\logo.png') }}" style="width: 40px;">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li
                    ...
                    <ul class="c-sidebar-nav-dropdown-items" style="background-color: #edebeb;">
                        ...
                        @can('unchecked_student_access')
                            <li><a href="{{ route('admin.student.Unchecked') }}"><i
                                        class="feather icon-circle {{ request()->is('admin/Unchecked-student*') ? 'active' : '' }}"></i><span
                                        class="menu-item"
                                        data-i18n="{{ trans('cruds.student.Unchecked') }}">{{ trans('cruds.student.Unchecked') }}</span></a>
                            </li>
                        @endcan
                        @can('binding_student_access')
                            <li><a href="{{ route('admin.student.binding') }}"><i
                                        class="feather icon-circle {{ request()->is('admin/binding-student*') ? 'active' : '' }} "></i><span
                                        class="menu-item"
                                        data-i18n="{{ trans('cruds.student.binding') }}">{{ trans('cruds.student.binding') }}</span></a>
                            </li>
                        @endcan
                         @can('withdrawal_student_access')
                        <li><a href="{{ route('admin.student.withdrawal') }}"><i
                                    class="feather icon-circle {{ request()->is('admin/withdrawal-student*') ? 'active' : '' }}"></i><span
                                    class="menu-item"
                                    data-i18n="{{ trans('cruds.student.withdrawal') }}">{{ trans('cruds.student.withdrawal') }}</span></a>
                        </li>
                         @endcan  --}}
                        @can('approved_student_access')
                            <li><a href="{{ route('admin.student.approved') }}"><i
                                        ...
                                        class="menu-item"
                                        data-i18n="{{ trans('cruds.student.title') }}">{{ trans('cruds.student.title') }}</span></a>
                            </li>
                        @endcan
            ...
            @endcan
            @can('attendance_course_event_access')
                <li
                    class="c-sidebar-nav-dropdown {{ request()->is('admin/attendance-designs*') ? 'active open' : '' }}
                            {{ request()->is('admin/attendance-design-keys*') ? 'active open' : '' }}">
                    <a class="c-sidebar-nav-dropdown-toggle" href="#">
                        <i class="feather icon-list"></i>
                        <span class="menu-item">{{ trans('cruds.attendanceCourseEvent.title') }}</span>
                    </a>
                    <ul class="c-sidebar-nav-dropdown-items" style="background-color: #edebeb;">
                        @can('attendance_design_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.attendance-designs.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/attendance-designs') || request()->is('admin/attendance-designs/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item">{{ trans('cruds.attendanceDesign.title') }}</span>
                                </a>
                            </li>
                        @endcan

                        @can('attendance_design_key_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.attendance-design-keys.index') }}"
                                   class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/attendance-design-keys') || request()->is('admin/attendance-design-keys/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item">{{ trans('cruds.attendanceDesignKey.title') }}</span>
                                </a>
                            </li>
                        @endcan
            ...
            @can('reservation_access')
                <li
                    ...
                    {{ request()->is('admin/wallet_transactions*') ? 'active open' : '' }}
                    ...
                    <ul class="c-sidebar-nav-dropdown-items" style="background-color: #edebeb;">
                        ...
                        @can('wallet_transaction_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.reservations.wallet_transactions') }}"
                                   class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/wallet_transactions') || request()->is('admin/wallet_transactions/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item">{{ trans('cruds.walletTransaction.title') }}</span>
                                </a>
                            </li>
                        @endcan
            ...
            @endcan
            @can('technical_support_ticket_access')
                <li
                    class="c-sidebar-nav-dropdown
                    {{ request()->is('admin/tickets*') ? 'active open' : '' }}
                    {{ request()->is('admin/ticket-categories*') ? 'active open' : '' }}
                     {{ request()->is('admin/ticket-comments*') ? 'active open' : '' }}
                   ">

                    <a class="c-sidebar-nav-dropdown-toggle" href="#">
                        <i class="feather icon-list"></i>
                        <span class="menu-item"> {{ trans('cruds.technicalSupportTicket.title') }}</span>
                    </a>

                    <ul class="c-sidebar-nav-dropdown-items" style="background-color: #edebeb;">
                        @can('ticket_category_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.ticket-categories.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/ticket-categories') || request()->is('admin/ticket-categories/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.ticketCategory.title') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('ticket_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.tickets.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/tickets') || request()->is('admin/tickets/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.ticket.title') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('ticket_comment_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.ticket-comments.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/ticket-comments') || request()->is('admin/ticket-comments/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.ticketComment.title') }}</span>
                                </a>
                            </li>
                        @endcan
                    </ul>
            ...
            @can('afaq_business_access')

                <li
                    class="c-sidebar-nav-dropdown {{ request()->is('admin/business-banners*') ? 'active open' : '' }}
                    {{ request()->is('admin/business-needs*') ? 'active open' : '' }}
                    {{ request()->is('admin/business-medical-types*') ? 'active open' : '' }}
                    {{ request()->is('admin/business-features*') ? 'active open' : '' }}
                    {{ request()->is('admin/business-packages*') ? 'active open' : '' }}
                      {{ request()->is('admin/business-payments*') ? 'active open' : '' }}
                        {{ request()->is('admin/business-partners*') ? 'active open' : '' }}
                    {{ request()->is('admin/business-event-types*') ? 'active open' : '' }}
                         {{ request()->is('admin/business-special-requests*') ? 'active open' : '' }}
                    ">
                    <a class="c-sidebar-nav-dropdown-toggle" href="#">
                        <i class="feather icon-list"></i>
                        <span class="menu-item">  {{ trans('cruds.afaqBusiness.title') }}</span>
                    </a>
                    <ul class="c-sidebar-nav-dropdown-items" style="background-color: #edebeb;">
                        @can('business_banner_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.business-banners.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/business-banners') || request()->is('admin/business-banners/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.businessBanner.title') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('business_need_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.business-needs.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/business-needs') || request()->is('admin/business-needs/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.businessNeed.title') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('business_medical_type_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.business-medical-types.index') }}"
                                   class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/business-medical-types') || request()->is('admin/business-medical-types/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.businessMedicalType.title') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('business_feature_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.business-features.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/business-features') || request()->is('admin/business-features/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.businessFeature.title') }}</span>
                                </a>
                            </li>
                        @endcan

                        @can('business_package_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.business-packages.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/business-packages') || request()->is('admin/business-packages/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.businessPackage.title') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('business_partner_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.business-partners.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/business-partners') || request()->is('admin/business-partners/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.businessPartner.title') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('business_payment_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.business-payments.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/business-payments') || request()->is('admin/business-payments/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.businessPayment.title') }}</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('business_event_type_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.business-event-types.index') }}" class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/business-event-types') || request()->is('admin/business-event-types/*') ? 'active' : '' }}"></i>
                                    <span class="menu-item"> {{ trans('cruds.businessEventType.title') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('business_special_request_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.business-special-requests.index') }}"
                                   class="c-sidebar-nav-link">
                                    <i
                                        class="feather icon-circle {{ request()->is('admin/business-special-requests') || request()->is('admin/business-special-requests/*') ? 'active' : '' }}"></i>
                                    <span
                                        class="menu-item">  {{ trans('cruds.businessSpecialRequest.title') }}</span>
                                </a>
                            </li>
                        @endcan
                   ...
                   ">
                                ...
                                <ul class="c-sidebar-nav-dropdown-items" style="background-color: #edebeb;">
                                            ...
                                            <a href="{{ route('admin.ticket-categories.index') }}"
                                               class="c-sidebar-nav-link">
                                                <i
                                                    class="feather icon-circle {{ request()->is('admin/ticket-categories') || request()->is('admin/ticket-categories/*') ? 'active' : '' }}"></i>
                                                <span
                                                    class="menu-item"> {{ trans('cruds.ticketCategory.title') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('ticket_access')
                                    ...
                                    @can('ticket_comment_access')
                                        <li class="c-sidebar-nav-item">
                                            <a href="{{ route('admin.ticket-comments.index') }}"
                                               class="c-sidebar-nav-link">
                                                <i
                                                    class="feather icon-circle {{ request()->is('admin/ticket-comments') || request()->is('admin/ticket-comments/*') ? 'active' : '' }}"></i>
                                                <span
                                                    class="menu-item"> {{ trans('cruds.ticketComment.title') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                </ul>
                    ...
                    ">
                                ...
                                <ul class="c-sidebar-nav-dropdown-items" style="background-color: #edebeb;">
                                            ...
                                            <a href="{{ route('admin.content-categories.index') }}"
                                               class="c-sidebar-nav-link ">
                                                <i
                                                    class="feather icon-circle {{ request()->is('admin/content-categories') || request()->is('admin/content-categories/*') ? 'active' : '' }}"></i>
                                                <span
                                                    class="menu-item">{{ trans('cruds.contentCategory.title') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('content_tag_access')
                                    ...
                                    @can('blogscomment_access')
                                        <li class="c-sidebar-nav-item">
                                            <a href="{{ route('admin.blogscomments.index') }}"
                                               class="c-sidebar-nav-link ">
                                                <i
                                                    class="feather icon-circle {{ request()->is('admin/blogscomments') || request()->is('admin/blogscomments/*') ? 'active' : '' }}">
                                                </i>
                                                <span
                                                    class="menu-item"> {{ trans('cruds.blogscomment.title') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('content_page_access')
                                        <li class="c-sidebar-nav-item">
                                            <a href="{{ route('admin.content-pages.index') }}"
                                               class="c-sidebar-nav-link ">
                                                ...
                                                <span
                                                    class="menu-item"> {{ trans('cruds.contentPage.title') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('enquiry_access')
                ...
                <li
                    ...
                    <ul class="c-sidebar-nav-dropdown-items" style="background-color: #edebeb;">
                        ...
                        @can('notification_campain_access')
                            <li class="c-sidebar-nav-item">
                                <a href="{{ route('admin.notification-campains.index') }}"
                                   class="c-sidebar-nav-link">
                                    <i
