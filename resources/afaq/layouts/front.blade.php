...
<head>
    ...
    <!-- <meta name="description" content="{{ trans('panel.site_description') }}">
    ...
    <link href="{{ asset('afaq/assests/css/profile-style.css') }}" rel="stylesheet">
...
<body
    class="header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden login-page {{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
    ...
    @if (auth()->check() && $cart)
        <div class="fixed_cart_icon cart_popup" onclick="window.location.href='/ar/carts'">
        ...
        <div class="cart_popup_text" id="cartPopup">
            ...
            <i class="fa-solid fa-xmark" onclick="window.location.href='/ar/carts'"></i>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a class="pre-order-btn" href="https://afaq-lms.com/">
                        <img src="https://afaq-lms.com/popup.png" class="w-100" alt="">
                    </a>
                </div>
