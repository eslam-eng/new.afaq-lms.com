    ...
    <div class="container sit-container">
        <div class="all-courses">
            <div class="container">
                ...
                <div id="boxx">
                    <canvas id="c" style="border:1px solid #000000;margin-left:30px" width="795px" height="565px"></canvas>
                </div>
...
<script>
    ...
    function PrintElem() {
        ...
        var myElement = document.getElementById('boxx'),
            ...
            mywindow = window.open('', 'PRINT', 'height=565,width=800');
        ...
        mywindow.document.write("<style type='text/css' media='print'> @page { size: landscape; margin: 0mm; } body img { width: 100vw !important; height: 100vh !important; background-color: white; margin: 0; padding: 0; position: fixed; }</style>");
        mywindow.document.write(myElement.innerHTML);
