...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.hospital.title_singular') }} 
    </div>
...
<th></th>
                        ...
                        <th>
                            {{ trans('cruds.hospital.fields.name_en') }}
                        </th>
                        <th>
                            {{ trans('cruds.hospital.fields.name_ar') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
<td></td>
                        ...
                        <td>
                            @can('hospital_show')
                                ...
                                <a href="{{ route('admin.hospitals.show', $hospital->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('hospital_edit')
                                    ...
                                    <a href="{{ route('admin.hospitals.edit', $hospital->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
