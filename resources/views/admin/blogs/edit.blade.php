        ...
        <form method="POST" action="{{ route("admin.blogs.update", [$blog->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('editor') ? 'is-invalid' : '' }}" name="editor_id" id="editor_id" required>
                    ...
                    <option value="{{ $id }}" {{ (old('editor_id') ? old('editor_id') : $blog->editor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $blog->title_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('page_text_ar') ? 'is-invalid' : '' }}" name="page_text_ar" id="page_text_ar">{{ old('page_text_ar', $blog->page_text_ar) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('excerpt_ar') ? 'is-invalid' : '' }}" name="excerpt_ar" id="excerpt_ar">{{ old('excerpt_ar', $blog->excerpt_ar) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author') ? 'is-invalid' : '' }}" type="text" name="author" id="author" value="{{ old('author', $blog->author) }}" required>
...
{{--            $label.addClass('file-ok').css('background-image', "url({{($blog->featured_image->getUrl('thumb'))}} )");--}}
