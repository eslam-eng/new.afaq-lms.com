...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        ...
        <a class="btn btn-warning rate-btn" href="{{url('/admin/faq_categories/sorting')}}">{{ trans('cruds.faqCategory.fields.sort') }} </a>
...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.faqCategory.title_singular') }}
    </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-FaqCategory">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.faqCategory.fields.category_ar') }}
                        </th>
                        <th>
                            {{ trans('cruds.faqCategory.fields.category_en') }}
                        </th>
                        <th>
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $faqCategory->id }}">
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.faq-categories.show', $faqCategory->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            <a href="{{ route('admin.faq-categories.edit', $faqCategory->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
