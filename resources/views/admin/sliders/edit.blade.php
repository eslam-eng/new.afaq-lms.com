    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sliders.update", [$slider->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text" name="title_en" id="title_en" value="{{ old('title_en', $slider->title_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $slider->title_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control  {{ $errors->has('description_en') ? 'is-invalid' : '' }}" name="description_en" id="description_en">{!! old('description_en', $slider->description_en) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control  {{ $errors->has('description_ar') ? 'is-invalid' : '' }}" name="description_ar" id="description_ar">{!! old('description_ar', $slider->description_ar) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_en') ? 'is-invalid' : '' }}" type="text" name="link_en" id="link_en" value="{{ old('link_en', $slider->link_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_ar') ? 'is-invalid' : '' }}" type="text" name="link_ar" id="link_ar" value="{{ old('link_ar', $slider->link_ar) }}" required>
