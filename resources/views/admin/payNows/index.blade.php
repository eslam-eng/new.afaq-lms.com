        ...
        <div class="jumbotron text-center">
            ...
            @can('pay_now_access')
                <p class="btn btn-success  " style="font-size:  40px">
                    <img src="{{ asset('AFAQ.png') }}" class="col-lg-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group my-auto">
                                    <button type="button" class="btn btn-md mr-4 btn-primary" onclick="window.location.href='https://www.sna-academy.com/local/staticpage/view.php?page=BioandHealthInformatics-Prog';">Program Details</button>
                                   </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="card mb-6 mt-auto shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group my-auto">
                                    <button type="button" class="btn btn-md mr-4 btn-primary" onclick="window.location.href='https://www.sna-academy.com/local/staticpage/view.php?page=Egyptology-Prog';">Program Details</button>
                               </div>
                            </div>
                        </div>
                    </div>
