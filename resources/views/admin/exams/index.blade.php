            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Exam">
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $exam->id }}">
                        ...
                        <td>
                            {{ $exam->start_at ? date('Y-m-d h:i A' , strtotime($exam->start_at)) : '' }}
                        </td>
                        <td>
                            {{ $exam->end_at ? date('Y-m-d h:i A' , strtotime($exam->end_at)) : '' }}
                        </td>
                        <td>
                            @if($exam->image)
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.exams.edit', $exam->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
