        ...
        <form method="POST" action="{{ route("admin.exams.update", [$exam->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('exam_title') ? 'is-invalid' : '' }}" name="exams_title_id[]" id="exams_title_id" required >
                    @foreach($exam_titles as $key => $label)
                        <option value="{{ $key }}" {{ in_array($key , $exam_exam_content_selected_array) ? 'selected' : '' }}>{{ $label }}</option>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text" name="title_en" id="title_en" value="{{ old('title_en', $exam->title_en) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $exam->title_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description_en') ? 'is-invalid' : '' }}" name="description_en" id="description_en">{{ old('description_en', $exam->description_en) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description_ar') ? 'is-invalid' : '' }}" name="description_ar" id="description_ar" required>{{ old('description_ar', $exam->description_ar) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('tips_guidelines') ? 'is-invalid' : '' }}" name="tips_guidelines" id="tips_guidelines">{!! old('tips_guidelines', $exam->tips_guidelines) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_question') ? 'is-invalid' : '' }}" type="number" name="number_question" id="number_question" value="{{ old('number_question', $exam->number_question) }}"  required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('success_percentage') ? 'is-invalid' : '' }}" type="number" name="success_percentage" id="success_percentage" value="{{ old('success_percentage', $exam->success_percentage) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('certificate') ? 'is-invalid' : '' }}" name="certificate_id" id="certificate_id" >
                    @foreach($certificates as $id => $entry)
                        <option value="{{ $id }}" {{ (old('certificate_id') ? old('certificate_id') : $exam->certificate->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $exam->price) }}" step="1" required>
                @if($errors->has('price'))
                    <div class="invalid-feedback">
                        {{ $errors->first('price') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_at') ? 'is-invalid' : '' }}" type="datetime-local" name="start_at" id="start_at" value="{{ old('start_at', $exam->start_at) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_at') ? 'is-invalid' : '' }}" type="datetime-local" name="end_at" id="end_at" value="{{ old('end_at', $exam->end_at) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Exam::STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $exam->status) === (string) $key ? 'checked' : '' }} required>
