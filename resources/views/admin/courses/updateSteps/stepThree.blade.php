    ...
    <div class="row">
        <div class="form-group col-6">
            ...
            <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" type="text" name="name_en"
                id="name_en"  value="{{$course->name_en}}" required data-parsley-errors-container="#course_name_en" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}">
        ...
        <div class="form-group col-6">
            ...
            <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}" type="text" name="name_ar"
                id="name_ar" required  value="{{$course->name_ar}}" data-parsley-errors-container="#course_name_ar" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}">
        ...
        <div class="form-group col-6">
            ...
            <select class="form-control select2" name="evaluation" id="evaluation"
                data-parsley-errors-container="#evaluation_error" data-parsley-group="step-3" onchange="getAvailableEvaluation($(this).val())"  style="display: block;">
                <option value="" disabled> </option>
                <option value="available" {{$course->evaluation == 'available' ? 'selected' : ''}}>
                    {{ trans('cruds.course.fields.available') }}
                </option>
                <option value="unavailable" {{$course->evaluation == 'unavailable' ? 'selected' : ''}}>
        ...
        <div class="form-group col-6 full-evaluation" style="display: none;">
            ...
            <i>*</i>
            <select class="form-control select2" name="full_training_evaluation" data-parsley-group="step-3" id="full_training_evaluation"
                data-parsley-errors-container="#full_training_evaluation_error"  style="display: block;">
                <option value="" disabled> </option>
                <option value="stars" {{$course->full_training_evaluation == 'stars' ? 'selected' : ''}}>
                    {{ trans('cruds.course.fields.star_rating') }}
                </option>
                <option value="text_and_stars" {{$course->full_training_evaluation == 'text_and_stars' ? 'selected' : ''}}>
        ...
        <div class="row mx-0">
            <div class="form-group col-6">
                ...
                <textarea class="form-control ckeditor "
                    name="requirements_en" id="requirements_en" rows="3"  data-parsley-errors-container="#course_requirements_en" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}" >{{$course->requirements_en}}</textarea>
            ...
            <div class="form-group col-6">
                ...
                <i>*</i>
                <textarea class="form-control ckeditor {{ $errors->has('requirements_ar') ? 'is-invalid' : '' }}"
                    name="requirements_ar" id="requirements_ar" rows="3" data-parsley-errors-container="#course_requirements_ar" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}">{{$course->requirements_ar}}</textarea>
            ...
            <div class="form-group col-6">
                <label class="label-waves-effect" style="position:relative; top:0;" class="required "
                    for="introduction_to_course_en">{{ trans('cruds.course.fields.short_description_en') }}</label>
                <i>*</i>
                <textarea class="form-control ckeditor {{ $errors->has('introduction_to_course_en') ? 'is-invalid' : '' }}"
                    name="introduction_to_course_en" id="introduction_to_course_en" rows="3"  data-parsley-errors-container="#course_short_description_en" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}">{{$course->introduction_to_course_en}}</textarea>
            ...
            <div class="form-group col-6">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('short_description_ar') ? 'is-invalid' : '' }}"
                    name="introduction_to_course_ar" id="short_description_ar" rows="3" data-parsley-errors-container="#course_short_description_ar" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}">{{$course->introduction_to_course_ar}}</textarea>
            ...
            <div class="form-group col-6">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_en') ? 'is-invalid' : '' }}" name="description_en"
                    id="description_en" data-parsley-errors-container="#course_description_en" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}">{{$course->description_en}}</textarea>
            ...
            <div class="form-group col-6">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_ar') ? 'is-invalid' : '' }}" name="description_ar"
                    id="description_ar" data-parsley-errors-container="#course_description_ar" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}">{{$course->description_ar}}</textarea>
        ...
        <div class="col-4">
            <div class="form-group wrap-custom-file">
                ...
                <input type="file" value="{{ old('image_en', '') }}"  name="image_en" id="image_en" data-parsley-filemimetypes="image/jpeg, image/png" accept=".gif, .jpg, .png"  data-parsley-errors-container="#course_image_en" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}" data-parsley-max-file-size="2000"/>required
                <label for="image_en">
                    <span>Image EN</span>
        ...
        <div class="col-4">
            <div class="form-group wrap-custom-file">
                ...
                <input type="file" value="{{ old('image_ar', '') }}"  name="image_ar" id="image_ar" data-parsley-filemimetypes="image/jpeg, image/png" accept=".gif, .jpg, .png"  data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}" data-parsley-errors-container="#course_image_ar"  data-parsley-max-file-size="2000"/>required
                <label for="image_ar">
                    <span>Image Ar</span>
                    <i class="fa fa-plus-circle"></i>
                </label>
        ...
        <div class="col-4">
            <div class="form-group wrap-custom-file">
                ...
                <input type="file" value="{{ old('video', '') }}"  name="video" id="video" data-parsley-errors-container="#course_video" data-parsley-filemimetypes="video/mp4" accept=".mp4" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}"  data-parsley-max-file-size="6000" />
                <label for="video">
                    <span>Video</span>
                    <i class="fa fa-plus-circle"></i>
                </label>
        ...
        <div class="col-4">
            <div class="form-group wrap-custom-file">
                ...
                <input type="file" value="{{ old('banner_en', '') }}" data-parsley-errors-container="#course_banner_en" name="banner_en" id="banner_en"  data-parsley-filemimetypes="image/jpeg, image/png" accept=".gif, .jpg, .png" data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}"  data-parsley-max-file-size="2000" />
                <label for="banner_en">
                    <span>Banner EN</span>
                    <i class="fa fa-plus-circle"></i>
                </label>
        ...
        <div class="col-4">
            <div class="form-group wrap-custom-file">
                ...
                <input type="file" value="{{ old('banner_ar', '') }}" name="banner_ar" data-parsley-errors-container="#course_banner_ar" id="banner_ar" data-parsley-filemimetypes="image/jpeg, image/png" accept=".gif, .jpg, .png"  data-parsley-group="step-3" data-parsley-required-message="{{ trans('global.required') }}"  data-parsley-max-file-size="2000"/>required
                <label for="banner_ar">
                    <span>Banner Ar</span>
                    <i class="fa fa-plus-circle"></i>
                </label>
