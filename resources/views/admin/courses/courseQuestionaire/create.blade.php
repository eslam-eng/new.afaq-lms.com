...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.courses.course-questionaire.store', ['course_id' => $course_id]) }}"
                            ...
                            <div data-repeater-list="questions" class="w-100">
                                <div data-repeater-item class="row w-100 border mb-3">
                                    ...
                                    <div class="form-group col-6" style="display: grid;">
                                        ...
                                        <input type="file" value="{{ old('attachment', '') }}" name="attachment"
                                            id="attachment" data-parsley-required-message="{{ trans('global.required') }}"
                                    ...
                                    <div class="form-group col-12 d-flex flex-wrap justify-content-end">
                                        <div class="col-1">
                                            <label for=""class="w-100"></label>
                                            <button data-repeater-delete type="button" value="Delete"
                                                class="btn btn-danger  form-control px-0 w-75"> {{ __('lms.Remove') }} <i
                                                    class="fas fa-trash-alt"></i></button>
                                        </div>
                                    </div>
