...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.couponCode.title_singular') }} 
    </div>
...
<td></td>
                        ...
                        <td>
                            {{-- {{ $couponCode->course_coupon->name_en ?? '' }}--}}
                            @foreach($couponCode->course_coupon as $co_name)
                            {{-- {{$co_name->name_en ?? ''}} ,--}}
                            {{app()->getLocale()=='en' ? $co_name->name_en ?? '' : $co_name->name_ar ?? ''}} //
                            @endforeach
                        ...
                        <td>
                            @can('coupon_code_show')

                                <a href="{{ route('admin.coupon-codes.show', $couponCode->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('coupon_code_edit')

                                    <a href="{{ route('admin.coupon-codes.edit', $couponCode->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
                            ...
                            @can('coupon_code_delete')
                                    ...
                                    <form action="{{ route('admin.coupon-codes.destroy', $couponCode->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
