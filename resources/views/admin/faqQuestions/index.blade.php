...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        ...
        <a class="btn btn-warning rate-btn" href="{{url('/admin/faq_questions/sorting')}}">{{ trans('cruds.faqQuestion.fields.sort') }} </a>
...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.faqQuestion.title_singular') }}
    </div>
...
<td></td>
                        ...
                        <td>
                            @can('faq_question_show')
                                ...
                                <a  href="{{ route('admin.faq-questions.show', $faqQuestion->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('faq_question_edit')
                                    ...
                                    <a href="{{ route('admin.faq-questions.edit', $faqQuestion->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
