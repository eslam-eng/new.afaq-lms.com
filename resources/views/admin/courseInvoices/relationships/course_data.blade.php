                ...
                @foreach($courses as $key => $course)
                    <tr data-entry-id="{{ $course->course_id }}">
                        ...
                        <td>
                            ...
                            {{app()->getLocale()=='en' ? Str::limit($course->course_name_en, 50) : Str::limit($course->course_name_ar, 50)}}
                        </td>
                        <td>
                            {{ $course->price ?? '' }}
                        </td>
...
{{--                        </td>--}}
                        ...
                        <td>
                            <a href="{{ route('admin.courses.show', $course->course_id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
