                ...
                <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                    ...
                    <tbody>
                        ...
                        <tr data-entry-id="{{ $users->id??"" }}">
                            ...
                            <td>
                                <a href="{{ route('admin.users.show', [$users->id , 'type' => request()->segment(2)]) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
