...
<td></td>
                        ...
                        <td>
                            @can('role_show')
                                ...
                                <a href="{{ route('admin.roles.show', $role->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('role_edit')
                                    ...
                                    <a href="{{ route('admin.roles.edit', $role->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
