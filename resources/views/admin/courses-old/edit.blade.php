                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ trans('global.edit') }} {{ trans('cruds.course.title_singular') }}</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form id="course_form" method="POST" class="number-tab-steps wizard-circle" action="{{ route("admin.courses.update", [$course->id]) }}" enctype="multipart/form-data">
                                            @method('PUT')
                                            @csrf
                                            <!-- Step 1 -->
                                            <h6>Step 1</h6>
                                            <fieldset>
                                                <div class="row col-11">
                                                    ...
                                                    <div class="form-group col-6">
                                                        ...
                                                        <i>*</i>
                                                        <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" type="text" name="name_en" id="name_en" value="{{ old('name_en', $course->name_en) }}" required>
                                                    ...
                                                    <div class="form-group col-6">
                                                        ...
                                                        <i>*</i>
                                                        <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}" type="text" name="name_ar" id="name_ar" value="{{ old('name_ar', $course->name_ar) }}" required>
                                                    ...
                                                    <div class="form-group col-12">
                                                        ...
                                                        <select style="width: 100%;" class="form-control select2 {{ $errors->has('instructor') ? 'is-invalid' : '' }}" name="instructor_id[]" id="instructor_id[]" multiple>
                                                            ...
                                                            <option value="{{ $id }}" {{ in_array( $id, $course_instructor_selected_array)  ? 'selected' : '' }}>{{ $entry }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check {{ $errors->has('accreditation') ? 'is-invalid' : '' }}">
                                                                <input class="form-check-input" type="radio" id="accreditation_{{ $key }}" name="accreditation" value="{{ $key }}" {{ old('accreditation', $course->accreditation) == (string) $key ? 'checked' : '' }} required>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control {{ $errors->has('accreditation_number') ? 'is-invalid' : '' }}" type="number" name="accreditation_number" id="accreditation_number" value="{{ old('accreditation_number', $course->accreditation_number) }}" step="1">
                                                        ...
                                                        <div style="display: none;" id="show-me" class="form-group">
                                                            ...
                                                            <select class="form-control select2 {{ $errors->has('course_sub_specialty') ? 'is-invalid' : '' }}" name="course_sub_specialty_id[]" id="course_sub_specialty_id" multiple>
                                                                ...
                                                                <option value="{{ $id }}" {{ in_array( $id, $course_sub_specialty_selected_array)  ? 'selected' : '' }}>{{ $entry }}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $course->price) }}" step="1">
                                                            @if($errors->has('price'))
                                                            <div class="invalid-feedback">
                                                                {{ $errors->first('price') }}
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            <div class="form-group col-6">
                                                                ...
                                                                <i>*</i>
                                                                <textarea class="form-control ckeditor {{ $errors->has('description_en') ? 'is-invalid' : '' }}" name="description_en" id="description_en">{{ old('description_en', $course->description_en) }}</textarea>
                                                            ...
                                                            <div class="form-group col-6">
                                                               ...
                                                               <i>*</i>
                                                                <textarea class="form-control ckeditor {{ $errors->has('description_ar') ? 'is-invalid' : '' }}" name="description_ar" id="description_ar">{{ old('description_ar', $course->description_ar) }}</textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <i>*</i>
                                                            <input class="form-control {{ $errors->has('image_title_en') ? 'is-invalid' : '' }}" type="text" name="image_title_en" id="image_title_en" value="{{ old('image_title_en', $course->image_title_en) }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control {{ $errors->has('image_title_ar') ? 'is-invalid' : '' }}" type="text" name="image_title_ar" id="image_title_ar" value="{{ old('image_title_ar', $course->image_title_ar) }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control  {{ $errors->has('introduction_to_course_en') ? 'is-invalid' : '' }}" name="introduction_to_course_en" id="introduction_to_course_en">{!! old('introduction_to_course_en', $course->introduction_to_course_en) !!}</textarea>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control  {{ $errors->has('introduction_to_course_ar') ? 'is-invalid' : '' }}" name="introduction_to_course_ar" id="introduction_to_course_ar">{!! old('introduction_to_course_ar', $course->introduction_to_course_ar) !!}</textarea>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row col-12">
                                                            <div class="form-group col-6">
                                                                ...
                                                                <i>*</i>
                                                                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="date" name="start_date" id="start_date" {{--                                                                       value="{{ old('start_date', $course->start_date) }}" required>--}}
                                                                value="{{ date("Y-m-d" , strtotime($course->start_date)) }}" required>
                                                            ...
                                                            <div class="form-group col-6">
                                                                ...
                                                                <i>*</i>
                                                                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="date" name="end_date" id="end_date" {{--                                                                       value="{{ old('end_date', $course->end_date) }}" required>--}}
                                                                value="{{ date("Y-m-d" , strtotime($course->end_date)) }}" required>
                                                        ...
                                                        <div class="row col-12">
                                                            <div class="form-group col-6">
                                                                ...
                                                                <i>*</i>
                                                                <input class="form-control date {{ $errors->has('start_register_date') ? 'is-invalid' : '' }}" type="date" name="start_register_date" id="start_register_date" {{--                                                                       value="{{ old('start_register_date', $course->start_register_date) }}" required>--}}
                                                                value="{{ date("Y-m-d" , strtotime($course->start_register_date)) }}" required>
                                                            ...
                                                            <div class="form-group col-6">
                                                              ...
                                                              <i>*</i>
                                                                <input class="form-control date {{ $errors->has('end_register_date') ? 'is-invalid' : '' }}" type="date" name="end_register_date" id="end_register_date" {{--                                                                       value="{{ old('end_register_date', $course->end_register_date) }}" required>--}}
                                                                value="{{ date("Y-m-d" , strtotime($course->end_register_date)) }}" required>
                                                        ...
                                                        <div class="row col-12">
                                                            ...
                                                            <div class="form-group col-12">
                                                                ...
                                                                <input class="form-control date {{ $errors->has('early_register_date') ? 'is-invalid' : '' }}" type="date" name="early_register_date" value="{{ date("Y-m-d" , strtotime($course->early_register_date)) }}" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control {{ $errors->has('certificate_price') ? 'is-invalid' : '' }}" type="number" name="certificate_price" id="certificate_price" value="{{ old('certificate_price', $course->certificate_price) }}" step="1" required>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control {{ $errors->has('course_place') ? 'is-invalid' : '' }}" name="course_place" onchange="showfield(this.options[this.selectedIndex].value)" id="course_place">
                                                                ...
                                                                <option value="{{ $key }}" {{ old('course_place', $course->course_place) === (string) $key ? 'selected' : '' }}>{{ trans('cruds.course.fields.'.$label)  }}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check {{ $errors->has('training_type') ? 'is-invalid' : '' }}">
                                                                <input class="form-check-input" type="radio" id="training_type_{{ $key }}" name="training_type" value="{{ $key }}" {{ old('training_type', $course->training_type) === (string) $key ? 'checked' : '' }} required>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <i>*</i>
                                                            <input class="form-control {{ $errors->has('lecture_hours') ? 'is-invalid' : '' }}" type="number" name="lecture_hours" id="lecture_hours" value="{{ old('lecture_hours', $course->lecture_hours) }}" step="1" required>
                                                        ...
                                                        <div class="form-group">
                                                          ...
                                                          <i>*</i>
                                                            <input class="form-control {{ $errors->has('seating_number') ? 'is-invalid' : '' }}" type="number" name="seating_number" id="seating_number" value="{{ old('seating_number', $course->seating_number) }}" step="1" required>
                                                        ...
                                                        <div class="form-group">
                                                           ...
                                                           <i>*</i>
                                                            ...
                                                            <select style="width: 100%;" class="form-control select2 {{ $errors->has('course_accreditation_sponsor') ? 'is-invalid' : '' }}" name="course_accreditation_sponsor[]" id="course_accreditation_sponsor" multiple>
                                                                ...
                                                                <option value="{{ $key }}" {{ in_array($key , $course_accreditations_selected_array) ? 'selected' : '' }}>{{ $label  }}</option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <fieldset>
                                                <div class="row col-12">
                                                    ...
                                                    <div class="form-group wrap-custom-file">
                                                        ...
                                                        <input type="file" value="{{$course->image ? $course->image->url : null}}" name="image" id="image1" accept=".gif, .jpg, .png" />
                                                        <label for="image1">
                                                            <span>Image </span>
                                                    ...
                                                    <div class="form-group col-12">
                                                        ...
                                                        <select style="width: 100%;" class="form-control select2  {{ $errors->has('cooperate_accreditation_sponsor') ? 'is-invalid' : '' }}" name="cooperate_accreditation_sponsor[]" id="cooperate_accreditation_sponsor" multiple>
                                                            @foreach($accreditation_sponsor as $key => $label)
                                                            <option value="{{ $key }}" {{ in_array($key , $course_Cooperated_accreditations_selected_array) ? 'selected' : '' }}>{{$label}}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="form-group col-12">
                                                        ...
                                                        <select style="width: 100%;" class="form-control select2 {{ $errors->has('hosting_cooperate_accreditation_sponsor') ? 'is-invalid' : '' }}" name="hosting_cooperate_accreditation_sponsor[]" multiple id="hosting_cooperate_accreditation_sponsor">
                                                            @foreach($accreditation_sponsor as $key => $label)
                                                            <option value="{{ $key }}" {{ in_array($key , $course_Hosted_accreditations_selected_array) ? 'selected' : '' }}>{{ $label  }}</option>
                                                            @endforeach
                                                        </select>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('input[type="file"]').each(function() {
                ...
                $label.addClass('file-ok').css('background-image', "url({{($course->image->getUrl('thumb'))}} )");
