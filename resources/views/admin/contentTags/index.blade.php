...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.contentTag.title_singular') }} 
    </div>
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $contentTag->id }}">
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.content-tags.edit', $contentTag->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            <a href="{{ route('admin.content-tags.edit', $contentTag->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
