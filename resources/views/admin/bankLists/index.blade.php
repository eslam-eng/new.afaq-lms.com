...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.bankList.title_singular') }}
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-BankList">
                <thead>
                    <tr>
<th></th>
                        <th>
                ...
                <tbody>
                    @foreach($bankLists as $key => $bankList)
                        <tr data-entry-id="{{ $bankList->id }}">
                            ...
                            <td>
                                @can('bank_list_show')
{{--                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.bank-lists.show', $bankList->id) }}">--}}
{{--                                        {{ trans('global.view') }}--}}
{{--                                    </a>--}}
                                    <a href="{{ route('admin.bank-lists.show', $bankList->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                                ...
                                @can('bank_list_edit')
{{--                                    <a class="btn btn-xs btn-info" href="{{ route('admin.bank-lists.edit', $bankList->id) }}">--}}
{{--                                        {{ trans('global.edit') }}--}}
{{--                                    </a>--}}
                                        <a href="{{ route('admin.bank-lists.edit', $bankList->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
...
{{--                                    <form action="{{ route('admin.bank-lists.destroy', $bankList->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">--}}
