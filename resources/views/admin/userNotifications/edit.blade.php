        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.user-notifications.update", [$userNotification->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('parent_id') ? 'is-invalid' : '' }}" type="number" name="parent_id" id="parent_id" value="{{ old('parent_id', $userNotification->parent_id) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $userNotification->title) }}" required>
                    @if($errors->has('title'))
                        <div class="invalid-feedback">
                            {{ $errors->first('title') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('message') ? 'is-invalid' : '' }}" name="message" id="message">{{ old('message', $userNotification->message) }}</textarea>
