...
<div class="card">
    <div class="card-header">
        {{ trans('global.list') }} {{ trans('cruds.editor.title_singular') }} 
    </div>
...
<td></td>
                        ...
                        <td>
                            @can('editor_show')
                                ...
                                <a href="{{ route('admin.editors.show', $editor->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('editor_edit')
                                    ...
                                    <a href="{{ route('admin.editors.edit', $editor->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
