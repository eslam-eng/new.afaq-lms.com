            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Certificat">
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $certificat->id }}">
                        ...
                        <td>
                            @can('certificat_show')
                            {{-- <a href="{{ route('admin.certificats.show', $certificat->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            @can('certificat_edit')
                            <a href="{{ route('admin.certificats.edit', $certificat->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
