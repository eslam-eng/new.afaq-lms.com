                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $blogscomment->id }}">
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.blogscomments.edit', $blogscomment->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-primary waves-effect waves-float waves-light">
                            ...
                            <a href="{{ route('admin.blogscomments.edit', $blogscomment->id) }}" type="button" class="btn btn-icon btn-icon rounded-circle btn-warning waves-effect waves-float waves-light">
