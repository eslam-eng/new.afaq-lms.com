                            ...
                            <tr data-entry-id="{{ $cancelRequest->id }}">
                                ...
                                <td>
                                    @can('cancel_request_show')
                                        ...
                                        <a href="{{ route('admin.reservations.canceled', ['id' => $cancelRequest->payment_id,'course_id' => $cancelRequest->course_id]) }}" type="button"
                                        ...
                                        @endif
                                    @endcan
                                    @if(!$cancelRequest->approved)
                                    <button type="button" class="btn btn-icon btn-icon rounded-circle btn-info open-modal-button" cancel_request_id="{{ $cancelRequest->id }}" cancel_reason="{{ $cancelRequest->cancel_reason }}" course_id="{{ $cancelRequest->course_id }}" user_id="{{ $cancelRequest->user_id }}" refound_amount="{{$cancelRequest->amount}}"  data-toggle="modal" data-target="#exampleModal">
...
@section('scripts')
    ...
    <script>
        $('.open-modal-button').on('click',function(){
            ...
            $('.refound_value').val($(this).attr('refound_amount'));
        });
    </script>
@endsection
