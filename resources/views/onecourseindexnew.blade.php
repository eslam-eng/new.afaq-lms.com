                                                        ...
                                                        <div class="card-body">
                                                            @foreach ($section->lectures as $lecture)
                                                                ...
                                                                @elseif($lecture->type == 'video')
                                                                    <img src="{{ get_video_to_s3($lecture->file) }}">
                                                                @endif
                                                            @endforeach
                                                        </div>
                                                    </div>
                        ...
                        <div class="left_side_info col-lg-3 order-lg-2 order-1">
                            <div class="left_side_container">
                                ...
                                <div class="reservation_action">
                                    ...
                                    @if (!$reserved && isset($end_register_date) && $today < $end_register_date && !$check_exist)
                                    ...
                                    <ul class="course_features">
                                        ...
                                        @if ($oneCourse->courses_users()->count())
                                            <li class="d-flex flex-row">
                                                <span class="material-symbols-outlined">
                                                    group
                                                </span>
                                                ...
                                                <p class="left_numbers">{{ $oneCourse->courses_users()->count() }}</p>
                                            </li>
                                        @endif
