                    ...
                    <div class="Investing-Future-card">
                        <a href="{{url('/'.app()->getLocale().'/blogs/view/'.$v1->id)}}">
                            <div class="Investing-Future-img">
                                ...
                                <img src="{{isset($v1->featured_image->url) ? asset($v1->featured_image->url) : asset('nazil/imgs/logo.png')}}" alt="" >
                ...
                <div>
                    ...
                    <div class="blogslider  onweb-view ">
                        ...
                        <div class="blogslider-items" onclick="location.href='{{url('/'.app()->getLocale().'/blogs/view/'.$v1->id)}}'">
                            <img data-u="image" src="{{isset($v1->featured_image->url) ? asset($v1->featured_image->url) : asset('nazil/imgs/logo.png')}}" />
                            <div class="data-blog">
