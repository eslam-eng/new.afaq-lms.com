                        ...
                        <div class="blog-page">
                            ...
                            <div class="blog-thumbnail">
                                <div class="post_thumbnail">
                                    <img src="{{isset($blog->featured_image->url) ? asset($blog->featured_image->url) : asset('nazil/imgs/logo.png')}}" class="img-responsive wp-post-image" alt="Online CME hours for SCFHS" >
                                </div>
                            </div>
